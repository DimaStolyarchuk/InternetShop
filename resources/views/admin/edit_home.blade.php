                                ...
                                <form class="form-horizontal" role="form" action="{{ route('save_home') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="title" class="form-control" id="email1" value="{{$dataHomes->title ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1">Опис</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="description" class="form-control" id="email1" value="{{$dataHomes->description ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="action">
                                                    <option value="0" @if( isset($dataHomes->action) && $dataHomes->action == 0) selected @endif>No</option>
                                                    <option value="1" @if( isset($dataHomes->action) && $dataHomes->action == 1) selected @endif>Yes</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="priority" value="{{ $dataHomes->priority ?? '' }}" class="form-control" id="cono1"
