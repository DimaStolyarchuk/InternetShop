                        ...
                        <table class="table">
                            <div class="container-fluid">
                                <form class="form-horizontal" role="form" action="{{ route('save_product') }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="id" value="{{ isset($dataProducts->id) ? $dataProducts->id : '' }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="email1">Товар</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="product" class="form-control" id="email1"
                                                       placeholder="Товар">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="priority"  class="form-control" id="cono1"
